            ...
            <div className="w-full md:w-1/2 h-auto px-4 md:px-12 py-8 flex flex-col justify-between">
              <div>
                ...
                <h1 className="text-sm md:text-base">
                  ...
                  we live, <br /> breathe, and design, so our Chelsea boutique
                  became the hotbed for the <br /> London interior design
                  community.
                </h1>
              </div>
              <div className="my-10">
          ...
          <div className="px-4 md:px-8 py-12 text-[#2A254B] mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-8 mt-12 text-base md:text-lg">
              ...
              <div className="flex flex-col w-full md:w-1/4 p-4 rounded-lg">
                ...
                <p>
                  For our material and quality, you won&rsquo;t find better
                  prices anywhere.
                </p>
              </div>
